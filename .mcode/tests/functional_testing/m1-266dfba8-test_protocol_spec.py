...
Generated at: 2026-04-11T11:21:44.889245+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "expected_status": 200,
        "description": "List all products and verify response is an array",
        "setup": null,
        "cleanup": null
    },
    {
        ...
        "expected_status": 201,
        "description": "Create a product with all fields and verify 201 response with product data",
        "setup": null,
        "cleanup": {
    ...
    },
    {
        ...
        "expected_status": 400,
        "description": "Attempt to create a product without name and price, expect 400 error",
        "setup": null,
        "cleanup": null
    },
    {
        ...
        "expected_status": 400,
        "description": "Attempt to create a product with a negative price, expect 400 error",
        "setup": null,
        "cleanup": null
    },
    {
    ...
    },
    {
        ...
        "endpoint": "/api/products/{id}",
        "method": "PUT",
        "description": "Create a product, attempt to update with empty body, expect 400",
        "setup": {
            "endpoint": "/api/products",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/products/{id}",
        "method": "DELETE",
        "description": "Create a product, then delete it and verify 204 response",
        "setup": {
            "endpoint": "/api/products",
            "method": "POST",
            "body": {
