...
Generated at: 2026-04-11T12:34:59.119971+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "method": "GET",
        "description": "List all products, expecting an array response (may include seed data)",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/api/products",
        "method": "POST",
        "description": "Create a product with all valid fields and verify 201 response",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/products/{id}",
        "method": "DELETE",
        "description": "Create a product, then delete it successfully with 204 response",
        "setup": {
            "endpoint": "/api/products",
            "method": "POST",
            "body": {
