...
Generated at: 2026-05-15T10:25:04.039194+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/health",
        "method": "GET",
        "description": "Verify health endpoint returns status and service connectivity info",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "request_data": {
            ...
            "body": {
                "name": "Test Widget",
                "description": "A test widget for API validation",
                "price": 19.99,
                "stock": 25
            }
        },
    ...
    },
    {
        ...
        "endpoint": "/api/products/{id}",
        "method": "PUT",
        "description": "Attempt to update a product with an empty body (no updatable fields), expect 400",
        "setup": {
            "endpoint": "/api/products",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/products/{id}",
        "method": "DELETE",
        "description": "Attempt to delete a product that does not exist, expect 404",
        "request_data": {
            "path": {
                "id": 999999
            },
