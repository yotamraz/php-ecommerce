...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "method": "GET",
        "description": "List all products \u2014 should return an array (seeded data or empty)",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/api/products",
        "method": "POST",
        "description": "Create a product with only required fields (name, price) \u2014 description and stock should default",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/products",
        "method": "POST",
        "description": "Attempt to create a product with price of 0 \u2014 must be greater than zero",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "setup": {
            ...
            "body": {
                ...
                "description": "Product created for GET test",
                "price": 34.5,
                "stock": 25
            },
            "extract_id_from": "id"
    ...
    },
    {
        ...
        "endpoint": "/api/products/{id}",
        "method": "PUT",
        "description": "Create a product, update its name and price, verify 200 response, then clean up",
        "setup": {
            "endpoint": "/api/products",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "setup": {
            ...
            "body": {
                ...
                "description": "Product created to be deleted",
                "price": 5.99,
                "stock": 1
            },
            "extract_id_from": "id"
