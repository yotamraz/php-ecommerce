...
Generated at: 2026-04-11T22:45:58.131246+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/health",
        "method": "GET",
        "description": "Verify health endpoint returns ok status with mysql service connected",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "method": "GET",
        "description": "List all products, returns an array (may be empty on fresh DB)",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/api/products",
        "method": "POST",
        "description": "Create a product with all fields, verify 201 response with product data",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/products",
        "method": "POST",
        "description": "Create a product with only required fields (name and price), stock defaults to 0",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/products",
        "method": "POST",
        "description": "Attempt to create product without name, expect validation error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    {
        "name": "create_product_missing_price",
        "category": "MISSING_REQUIRED",
        "endpoint": "/api/products",
        "method": "POST",
        "description": "Attempt to create product without price, expect validation error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    {
        "name": "create_product_zero_price",
        "category": "INVALID_INPUT",
        "endpoint": "/api/products",
        "method": "POST",
        "description": "Attempt to create product with price = 0, expect validation error (price must be > 0)",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/products",
        "method": "POST",
        "description": "Attempt to create product with negative stock, expect validation error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "setup": {
            ...
            "body": {
                ...
                "description": "Product to be fetched by ID",
                "price": 25.0,
                "stock": 10
            },
            "extract_id_from": "id"
    ...
    },
    {
        ...
        "endpoint": "/api/products/{id}",
        "method": "PUT",
        "description": "Create a product, update its name and price, then clean up",
        "setup": {
            "endpoint": "/api/products",
            "method": "POST",
            "body": {
    ...
    {
        "name": "update_product_empty_body",
        "category": "INVALID_INPUT",
        "endpoint": "/api/products/{id}",
        "method": "PUT",
        "description": "Attempt to update a product with no fields provided, expect 400",
        "setup": {
            "endpoint": "/api/products",
            "method": "POST",
            "body": {
