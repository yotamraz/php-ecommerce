...
Generated at: 2026-04-10T21:50:08.374379+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/health",
        "method": "GET",
        "description": "Verify health endpoint returns ok status with mysql and redis services connected",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "method": "GET",
        "description": "List all products \u2014 returns an array (may be empty on fresh database)",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/api/products",
        "method": "POST",
        "description": "Create a product with all fields, verify 201 response with product data, then delete it",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/products",
        "method": "POST",
        "description": "Create a product with only required fields (name, price), verify defaults for description and stock",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/products/{product_id}",
        "method": "GET",
        "description": "Request a product with an ID that does not exist \u2014 expect 404",
        "request_data": {
            "path": {
                "product_id": 999999
            },
    ...
    },
    {
        ...
        "endpoint": "/api/products/{product_id}",
        "method": "PUT",
        "description": "Create a product, update its name and price, verify response, then delete it",
        "setup": {
            "endpoint": "/api/products",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/products/{product_id}",
        "method": "PUT",
        "description": "Attempt to update a product that does not exist \u2014 expect 404",
        "request_data": {
            "path": {
                "product_id": 999999
            },
    ...
    },
    {
        ...
        "endpoint": "/api/products/{product_id}",
        "method": "PUT",
        "description": "Create a product then send an empty update body \u2014 expect 400 'No fields to update'",
        "setup": {
            "endpoint": "/api/products",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/products/{product_id}",
        "method": "DELETE",
        "description": "Create a product and then delete it \u2014 expect 204 No Content",
        "setup": {
            "endpoint": "/api/products",
            "method": "POST",
            "body": {
