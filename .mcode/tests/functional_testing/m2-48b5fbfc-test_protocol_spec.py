...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/health",
        "method": "GET",
        "description": "Verify health endpoint returns ok status with mysql, redis, and rabbitmq service statuses",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "method": "GET",
        "description": "List all products, returns an array (may be empty on fresh DB, or contain seed data)",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/api/products",
        "method": "POST",
        "description": "Create a product with all fields and verify 201 response",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/products",
        "method": "POST",
        "description": "Attempt to create a product without name and price, expect 400",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    {
        "name": "create_product_invalid_price_zero",
        "category": "INVALID_INPUT",
        "endpoint": "/api/products",
        "method": "POST",
        "description": "Attempt to create a product with price of zero, expect 400",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/products/{id}",
        "method": "GET",
        "description": "Attempt to retrieve a non-existent product, expect 404",
        "request_data": {
            "path": {
                "id": 999999
            },
    ...
    },
    {
        ...
        "endpoint": "/api/products/{id}",
        "method": "PUT",
        "description": "Create a product, update its name and price, verify 200",
        "setup": {
            "endpoint": "/api/products",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/products/{id}",
        "method": "PUT",
        "description": "Attempt to update a non-existent product, expect 404",
        "request_data": {
            "path": {
                "id": 999999
            },
    ...
    },
    {
        ...
        "endpoint": "/api/products/{id}",
        "method": "PUT",
        "description": "Attempt to update a product with empty body, expect 400",
        "setup": {
            "endpoint": "/api/products",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/products/{id}",
        "method": "DELETE",
        "description": "Create a product then delete it, expect 204",
        "setup": {
            "endpoint": "/api/products",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/products/{id}",
        "method": "DELETE",
        "description": "Attempt to delete a non-existent product, expect 404",
        "request_data": {
            "path": {
                "id": 999999
            },
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "GET",
        "description": "List all orders, returns an array (may be empty on fresh DB)",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "POST",
        "description": "Create a product with stock, then place an order for it, expect 201 with order details and items",
        "setup": {
            "endpoint": "/api/products",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "POST",
        "description": "Attempt to create order with empty items array, expect 400",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "POST",
        "description": "Attempt to create order without items field, expect 400",
        "request_data": {
            "path": {},
            "query": {},
            "body": {}
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "POST",
        "description": "Attempt to create order referencing a non-existent product, expect 400",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Create an order using a setup product, then retrieve the order by ID with items",
        "setup": {
            "endpoint": "/api/orders",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/orders/{id}",
        "method": "GET",
        "description": "Attempt to retrieve a non-existent order, expect 404",
        "request_data": {
            "path": {
                "id": 999999
            },
    ...
    {
        "name": "delete_product_with_orders_conflict",
        "category": "BOUNDARY",
        "endpoint": "/api/products/{id}",
        "method": "DELETE",
        "description": "Create an order for seed product ID 1, then attempt to delete that product, expect 409 conflict due to FK constraint",
        "setup": {
            "endpoint": "/api/orders",
            "method": "POST",
            "body": {
