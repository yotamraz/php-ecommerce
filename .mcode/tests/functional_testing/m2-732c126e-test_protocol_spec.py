...
Generated at: 2026-04-10T20:23:43.586642+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/health",
        "method": "GET",
        "description": "Verify health endpoint returns status and service connectivity including Redis",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "method": "GET",
        "description": "List all products, returns an array (may be empty on a fresh database or contain seeded data)",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/api/products",
        "method": "POST",
        "description": "Create a product with all fields and verify 201 response with the created product",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/products",
        "method": "POST",
        "description": "Attempt to create a product with price of zero, expect 400 error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Create a product, then retrieve it by ID, then clean up",
        "setup": {
            "endpoint": "/api/products",
            "method": "POST",
            "body": {
                "name": "Fetchable Gadget",
                "description": "A gadget to be fetched by ID",
                "price": 34.5,
                "stock": 25
            },
            "extract_id_from": "id"
