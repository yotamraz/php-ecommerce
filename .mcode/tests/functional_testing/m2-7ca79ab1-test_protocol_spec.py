...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "POST",
        "description": "Attempt to create an order without the required items array. Expects validation error.",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "POST",
        "description": "Attempt to create an order referencing a product ID that does not exist. Expects 400 product not found error.",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "GET",
        "description": "List all orders. Returns 200 with an array of orders sorted newest first.",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "GET",
        "description": "Create an order via setup using seeded product, then list orders to verify the created order appears in the response.",
        "setup": {
            "endpoint": "/api/orders",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Create an order via setup using seeded product, then retrieve it by ID. Verifies 200 response with order details including nested items with product names.",
        "setup": {
            "endpoint": "/api/orders",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/orders/{id}",
        "method": "GET",
        "description": "Attempt to retrieve an order with a non-existent ID. Expects 404 not found error.",
        "setup": null,
        "request_data": {
            "path": {
                "id": 999999
