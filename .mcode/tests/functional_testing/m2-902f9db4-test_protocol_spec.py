...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/api/orders",
        "method": "GET",
        "description": "List orders returns a 200 with an array (may be empty on fresh DB)",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    {
        "name": "list_orders_after_order_created",
        "category": "HAPPY_PATH",
        "endpoint": "/api/orders",
        "method": "GET",
        "description": "Create an order via setup, then list orders. Verifies the list includes at least one order with expected fields.",
        "setup": {
            "endpoint": "/api/orders",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "POST",
        "description": "Attempt to create an order with an empty items array. Expects 400 with 'items array is required' error.",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "POST",
        "description": "Attempt to create an order without the items field at all. Expects 400.",
        "request_data": {
            "path": {},
            "query": {},
            "body": {}
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "POST",
        "description": "Attempt to create an order referencing a non-existent product ID. Expects 400 with 'Product 999999 not found' error.",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Create an order via setup using a seed product, then retrieve the order by its ID. Verifies 200 response with nested items array including product_name.",
        "setup": {
            "endpoint": "/api/orders",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/orders/{id}",
        "method": "GET",
        "description": "Attempt to retrieve an order with a non-existent ID. Expects 404 with 'Order not found' error.",
        "request_data": {
            "path": {
                "id": 999999
            },
