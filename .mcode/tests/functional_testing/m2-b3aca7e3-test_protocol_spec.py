...
Generated at: 2026-04-11T12:35:57.496776+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Verify listing products returns 200 with an array of products",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "setup": {
            ...
            "body": {
                "name": "Test Widget",
                "description": "A widget for testing GET by ID",
                "price": 15.99,
                "stock": 10
            },
            "extract_id_from": "id"
    ...
    },
    {
        ...
        "endpoint": "/api/products/{id}",
        "method": "GET",
        "description": "Attempt to get a product with a non-existent ID and expect 404",
        "setup": null,
        "request_data": {
            "path": {
                "id": 999999
    ...
    },
    {
        ...
        "endpoint": "/api/products",
        "method": "POST",
        "description": "Create a valid product with all fields and expect 201",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/api/products/{id}",
        "method": "PUT",
        "description": "Create a product then attempt to update with empty body, expect 400",
        "setup": {
            "endpoint": "/api/products",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "setup": {
            ...
            "body": {
                ...
                "description": "Product created solely to be deleted",
                "price": 9.99,
                "stock": 1
            },
            "extract_id_from": "id"
