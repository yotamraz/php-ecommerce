...
Generated at: 2026-05-15T10:25:57.336304+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/api/orders",
        "method": "GET",
        "description": "List all orders - returns array (may be empty on fresh DB)",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    {
        "name": "create_order_happy_path_single_item",
        "category": "HAPPY_PATH",
        "endpoint": "/api/orders",
        "method": "POST",
        "description": "Create a product then create an order with a single item referencing that product",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
        ...
        "setup": {
            ...
            "body": {
                ...
                "description": "A wireless mouse for order test",
                "price": 29.99,
                "stock": 150
            },
            "extract_id_from": "id"
    ...
    {
        "name": "create_order_happy_path_multiple_items",
        "category": "HAPPY_PATH",
        "endpoint": "/api/orders",
        "method": "POST",
        "description": "Create an order with multiple different products from seed data",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "POST",
        "description": "Attempt to create an order without the items array - expects 400",
        "request_data": {
            "path": {},
            "query": {},
            "body": {}
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "POST",
        "description": "Attempt to create an order with an empty items array - expects 400",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    {
        "name": "create_order_invalid_quantity_zero",
        "category": "INVALID_INPUT",
        "endpoint": "/api/orders",
        "method": "POST",
        "description": "Attempt to create an order with quantity less than 1 - expects 400",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "POST",
        "description": "Attempt to create an order referencing a product that does not exist - expects 400",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "POST",
        "description": "Attempt to order more than available stock for Webcam HD (id=5, stock=60) - expects 400",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Create an order then retrieve it by ID - verify it includes items with product_name",
        "setup": {
            "endpoint": "/api/orders",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/orders/{id}",
        "method": "GET",
        "description": "Attempt to retrieve a non-existent order - expects 404",
        "request_data": {
            "path": {
                "id": 999999
            },
