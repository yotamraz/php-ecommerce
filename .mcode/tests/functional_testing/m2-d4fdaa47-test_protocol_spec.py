...
Generated at: 2026-05-15T10:24:38.377860+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "POST",
        "description": "Create an order with a single item using seed product (Wireless Mouse, id=1, price=29.99, stock=150)",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
