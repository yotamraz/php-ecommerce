...
Generated at: 2026-04-11T12:40:03.896344+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/api/orders",
        "method": "GET",
        "description": "List all orders. Returns an array (possibly empty on fresh DB).",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "POST",
        "description": "Create an order with a single item referencing seeded product ID 1 (Wireless Mouse, stock 150). Expects 201 with order detail including items and product_name.",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "POST",
        "description": "Create an order with multiple line items referencing different seeded products. Verifies total calculation across items.",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "POST",
        "description": "Attempt to create an order without the items field. Expects 400 with error message.",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "POST",
        "description": "Attempt to create an order referencing a non-existent product ID. Expects 400 with product not found error.",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "POST",
        "description": "Attempt to order more quantity than available stock for seeded product ID 5 (Webcam HD, stock 60). Expects 400 insufficient stock error.",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    {
        "name": "create_order_zero_quantity",
        "category": "BOUNDARY",
        "endpoint": "/api/orders",
        "method": "POST",
        "description": "Attempt to create an order with quantity 0. Expects 400 since quantity must be at least 1.",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Create an order via setup, then retrieve it by ID. Verifies the response includes items with product_name.",
        "setup": {
            "endpoint": "/api/orders",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/orders/{id}",
        "method": "GET",
        "description": "Attempt to retrieve an order with a non-existent ID. Expects 404.",
        "setup": null,
        "request_data": {
            "path": {
                "id": 999999
