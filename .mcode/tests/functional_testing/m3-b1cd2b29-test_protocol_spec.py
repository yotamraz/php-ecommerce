...
Generated at: 2026-05-15T10:32:53.912576+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "method": "GET",
        "description": "List all products, verifying the endpoint returns an array (served from DB or cache)",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Create a product, retrieve it by ID (populates cache), then clean up",
        "setup": {
            "endpoint": "/api/products",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/products/{id}",
        "method": "GET",
        "description": "Request a non-existent product ID, expect 404",
        "request_data": {
            "path": {
                "id": 999999
            },
    ...
    },
    {
        ...
        "endpoint": "/api/products",
        "method": "POST",
        "description": "Create a product with all fields, expect 201 and cache invalidation of products:all",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/products",
        "method": "POST",
        "description": "Attempt to create a product with zero price, expect 400",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/products/{id}",
        "method": "PUT",
        "description": "Create a product, update its name and price (invalidates cache), then clean up",
        "setup": {
            "endpoint": "/api/products",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/products/{id}",
        "method": "PUT",
        "description": "Create a product, attempt to update with empty body (no recognized fields), expect 400",
        "setup": {
            "endpoint": "/api/products",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/products/{id}",
        "method": "DELETE",
        "description": "Create a product then delete it, expect 204 and cache invalidation",
        "setup": {
            "endpoint": "/api/products",
            "method": "POST",
            "body": {
    ...
    {
        "name": "setup_product_for_order",
        "category": "SETUP",
        "endpoint": "/api/products",
        "method": "POST",
        "description": "Create a product to be used in order tests",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "POST",
        "description": "Place an order using the product created in setup, expect 201",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
                "items": [
                    {
                        "product_id": "$stored.order_product_id",
                        "quantity": 2
                    }
                ]
            }
