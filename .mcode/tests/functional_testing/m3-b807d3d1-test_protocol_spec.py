...
Generated at: 2026-04-10T20:52:16.949765+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/api/orders",
        "method": "GET",
        "description": "List all orders \u2014 returns 200 with a JSON array (may be empty on fresh DB)",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/api/orders/{id}",
        "method": "GET",
        "description": "Request a non-existent order ID and verify 404 with error message",
        "request_data": {
            "path": {
                "id": 999999
            },
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "POST",
        "description": "Submit an order with no items field in the body. Expect 400 error indicating items array is required.",
        "request_data": {
            "path": {},
            "query": {},
            "body": {}
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "POST",
        "description": "Submit an order with an empty items array. Expect 400 error since at least one item is required.",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "POST",
        "description": "Attempt to create an order referencing a non-existent product ID. Expect 400 error indicating product not found.",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
