...
Generated at: 2026-04-10T21:22:22.495974+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/health",
        "method": "GET",
        "description": "Verify health endpoint returns ok status with all three services (MySQL, Redis, RabbitMQ) connected",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "method": "GET",
        "description": "List all products and verify the response is an array",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/api/products",
        "method": "POST",
        "description": "Create a new product with all valid fields and verify 201 response",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
            "body": {
                "name": "Test Widget",
                "description": "A test widget for automated testing",
                "price": 19.99,
                "stock": 50
            }
        },
    ...
    },
    {
        ...
        "endpoint": "/api/products",
        "method": "POST",
        "description": "Attempt to create a product with a zero price, which must be greater than zero",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/api/products",
        "method": "POST",
        "description": "Attempt to create a product with negative stock value",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Create a product, retrieve it by ID, then delete it",
        "setup": {
            "endpoint": "/api/products",
            "method": "POST",
            "body": {
                "name": "Fetchable Gadget",
    ...
    },
    {
        ...
        "endpoint": "/api/products/{id}",
        "method": "GET",
        "description": "Attempt to retrieve a product with a non-existent ID",
        "setup": null,
        "request_data": {
            "path": {
                "id": 999999
    ...
    {
        "name": "update_product_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/api/products/{id}",
        "method": "PUT",
        "description": "Create a product, update its name and price, then delete it",
        "setup": {
            "endpoint": "/api/products",
            "method": "POST",
            "body": {
    ...
    {
        "name": "update_product_not_found",
        "category": "NOT_FOUND",
        "endpoint": "/api/products/{id}",
        "method": "PUT",
        "description": "Attempt to update a product that does not exist",
        "setup": null,
        "request_data": {
            "path": {
                "id": 999999
    ...
    {
        "name": "update_product_no_fields",
        "category": "INVALID_INPUT",
        "endpoint": "/api/products/{id}",
        "method": "PUT",
        "description": "Attempt to update a product with an empty body (no fields to update)",
        "setup": {
            "endpoint": "/api/products",
            "method": "POST",
            "body": {
    ...
    {
        "name": "delete_product_happy_path",
        "category": "HAPPY_PATH",
        "endpoint": "/api/products/{id}",
        "method": "DELETE",
        "description": "Create a product and then delete it, expecting 204 No Content",
        "setup": {
            "endpoint": "/api/products",
            "method": "POST",
            "body": {
    ...
    {
        "name": "delete_product_referenced_by_order",
        "category": "INVALID_INPUT",
        "endpoint": "/api/products/{id}",
        "method": "DELETE",
        "description": "Create an order referencing seeded product 1, then attempt to delete that product (expect 409 conflict due to FK constraint on order_items)",
        "setup": {
            "endpoint": "/api/orders",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "GET",
        "description": "List all orders and verify the response is an array",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "POST",
        "description": "Attempt to create an order without the required items array",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "POST",
        "description": "Attempt to create an order with an empty items array",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "POST",
        "description": "Attempt to create an order referencing a product that does not exist",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Create an order using seeded product 2, then retrieve the order by ID and verify it includes items with product_name",
        "setup": {
            "endpoint": "/api/orders",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/orders/{id}",
        "method": "GET",
        "description": "Attempt to retrieve an order with a non-existent ID",
        "setup": null,
        "request_data": {
            "path": {
                "id": 999999
