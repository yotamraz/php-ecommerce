...
Generated at: 2026-05-15T10:32:50.806826+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "endpoint": "/api/products",
        "method": "POST",
        "description": "Create a product with valid name, price, description, and stock",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/products",
        "method": "POST",
        "description": "Attempt to create a product with price of 0, expect 400 validation error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/products/{id}",
        "method": "GET",
        "description": "Request a product with a non-existent ID, expect 404",
        "request_data": {
            "path": {
                "id": 999999
            },
    ...
    },
    {
        ...
        "endpoint": "/api/products/{id}",
        "method": "PUT",
        "description": "Create a product, update its name and price, verify 200 response",
        "setup": {
            "endpoint": "/api/products",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/products/{id}",
        "method": "PUT",
        "description": "Attempt to update a product with an empty body, expect 400",
        "setup": {
            "endpoint": "/api/products",
            "method": "POST",
            "body": {
                "name": "No Fields Update Test",
                "price": 10.0
            },
            "extract_id_from": "id"
        },
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "GET",
        "description": "List all orders, returns an array",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "POST",
        "description": "Attempt to order a product that does not exist, expect 400",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/orders/{id}",
        "method": "GET",
        "description": "Request an order with a non-existent ID, expect 404",
        "request_data": {
            "path": {
                "id": 999999
            },
