...
Generated at: 2026-04-10T22:03:13.512781+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        "name": "health_check_all_services_connected",
        "category": "HAPPY_PATH",
        "endpoint": "/health",
        "method": "GET",
        "description": "Verify health endpoint returns ok status with MySQL, Redis, and RabbitMQ all reporting connected",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "POST",
        "description": "Create a product with stock, then create an order referencing that product. Verifies order creation returns 201 with order details and items.",
        "setup": {
            "endpoint": "/api/products",
            "method": "POST",
            "body": {
                "name": "Test Widget for Order",
                "description": "A test product used for order creation",
                "price": 24.99,
                "stock": 100
            },
            "extract_id_from": "id"
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "POST",
        "description": "Attempt to create an order without providing the items array. Expects 400 error.",
        "request_data": {
            "path": {},
            "query": {},
            "body": {}
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "POST",
        "description": "Attempt to create an order with an empty items array. Expects 400 error.",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "POST",
        "description": "Attempt to create an order referencing a product ID that does not exist. Expects 400 error.",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/orders",
        "method": "POST",
        "description": "Create a product with low stock, then attempt to order more than available. Expects 400 error for insufficient stock.",
        "setup": {
            "endpoint": "/api/products",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Create an order using a seed product, then retrieve it by ID. Verifies order includes items array with product name.",
        "setup": {
            "endpoint": "/api/orders",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/api/orders/{id}",
        "method": "GET",
        "description": "Attempt to retrieve an order with an ID that does not exist. Expects 404 error.",
        "request_data": {
            "path": {
                "id": 999999
            },
